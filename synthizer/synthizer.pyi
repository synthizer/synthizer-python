...
class FastSineBankGeneratorSine(Generator):
    def __init__(self, context: Context, frequency: float) -> None: ...

class FastSineBankGeneratorTriangle(Generator):
    def __init__(self, context: Context, frequency: float, partials: float) -> None: ...

class FastSineBankGeneratorSquare(Generator):
    def __init__(self, context: Context, frequency: float, partials: float) -> None: ...

class FastSineBankGeneratorSaw(Generator):
    def __init__(self, context: Context, frequency: float, partials: float) -> None: ...
