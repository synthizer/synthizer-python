...
class BiquadConfig:
    ...
    @staticmethod
    def design_lowpass(freequency: float, q: DoubleProperty = ...) -> "BiquadConfig": ...
    @staticmethod
    def design_highpass(frequency: float, q: DoubleProperty = ...) -> "BiquadConfig": ...
    @staticmethod
...
class _BaseObject:
    ...
    def config_delete_behavior(self, linger: bool = ..., linger_timout: DoubleProperty = ...): ...
...
class Context(Pausable):
    ...
    def config_route(
        ...
        input: GlobalEffect,
        gain: DoubleProperty = ...,
        fade_time: DoubleProperty = ...,
        filter: BiquadConfig = ...,
    ) -> None: ...
    def enable_events(self) -> None: ...
    def get_events(self, limit: int = ...) -> Iterator["Event"]: ...
    def remove_route(
        self, output: Source, input: GlobalEffect, fade_time: DoubleProperty = ...
    ) -> None: ...
...
class BufferGenerator(Generator):
    buffer: Optional[ObjectProperty] = None
    looping: IntProperty = ...
